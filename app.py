...
def main():
    ...
    for day, tab in zip(days, tabs):
        with tab:
            ...
            # Abendessen basierend auf Frühstück und Mittagessen
            selected_dinner = st.selectbox(f"Abendessen basierend auf deiner Frühstücks- und Mittagsauswahl ({day}):", matching_dinner_from_breakfast_lunch, key=f"dinner_{day}")
